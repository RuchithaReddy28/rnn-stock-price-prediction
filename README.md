...
![output](https://github.com/RuchithaReddy28/rnn-stock-price-prediction/blob/main/1.jpg?raw=true)
60 Inputs with 60 Neurons in the RNN Layer (hidden) and one neuron for the Output Layer.
![output](https://github.com/RuchithaReddy28/rnn-stock-price-prediction/blob/main/2.jpg?raw=true)
...
![output](https://github.com/RuchithaReddy28/rnn-stock-price-prediction/blob/main/5.1.jpg?raw=true)

### Mean Square Error

![output](https://github.com/RuchithaReddy28/rnn-stock-price-prediction/blob/main/5.2.jpg?raw=true)
